...
@Component({
  selector: 'app-pococart',
  templateUrl: './pococart.component.html',
  styleUrls: ['./pococart.component.css']
})
export class PococartComponent implements OnInit {
...
"q":user.q
  ...
  this.http.post("http://localhost:3000/user1/",this.userObj).subscribe((res: Response) => {
    this.isAdded = true;
